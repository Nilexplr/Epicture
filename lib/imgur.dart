...
class Imgur {
  ...
  authentificateClient(String refreshToken) async {
    ...
    String body = '{refresh_token: $refreshToken, client_id: $_clientId, client_secret: $_clientSecret, grant_type: refresh_token}';
    http.Response request = await http.post(Uri.parse("https://api.imgur.com/oauth2/token"), body: body, headers: headers);
